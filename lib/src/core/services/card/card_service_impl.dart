...
class CardServiceImpl extends CardService with KlashaBaseService {
  ...
  Future<ApiResponse> addBankCard(BankCardDetailsBody bankCardDetailsBody) async {
    final ApiResponse<AddBankCardResponse> apiResponse = ApiResponse(status: true);
    ...
    if (decodedResponseMap['status'] == 'error') {
      ...
      final AddBankCardResponse addBankCardResponse = AddBankCardResponse.fromJson(decodedResponseMap);
  ...
  Future<ApiResponse<AuthenticateBankCardResponse>> authenticateCardPayment(AuthenticateCardPaymentBody authenticateCardPaymentBody) async {
    final ApiResponse<AuthenticateBankCardResponse> apiResponse = ApiResponse(status: true);
    ...
    if (decodedResponseMap['status'] == 'error') {
      ...
      final AuthenticateBankCardResponse authenticateBankCardResponse = AuthenticateBankCardResponse.fromJson(decodedResponseMap);
  ...
  Future<ApiResponse> validateCardPayment(ValidateCardPaymentBody validateCardPaymentBody) async {
    final ApiResponse<ValidateBankCardResponse> apiResponse = ApiResponse(status: true);
    ...
    if (decodedResponseMap['status'] == 'error') {
      ...
      final ValidateBankCardResponse validateBankCardResponse = ValidateBankCardResponse.fromJson(decodedResponseMap);
